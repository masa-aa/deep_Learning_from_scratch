...
class TwoLayerNet:
    def __init__(self, input_size, hidden_size, output_size, weight_init_std=0.01):  # tips:stdはstandardの略
        # 重みの初期化 (Wはweight_init_std*ガウス分布に従う乱数,bは0)
        self.params = {}
